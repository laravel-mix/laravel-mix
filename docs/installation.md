...
If you are using windows you should install the `cross-env` package via `npm install cross-env --save-dev` and change the scripts to the following. Otherwise you'll get an error that "NODE_ENV" is not found.
